...
export default function Navbar() {
  ...
  const menuItems = [
    {
      href: "/profile", label: "Your Channel",
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>,
    },
    {
      href: "/activity-dashboard", label: "Activity Dashboard",
    ...
    {
      href: "/subscriptions", label: "Purchases & Memberships",
  ...
  <img src="/logo.png" alt="FluxTube" style={{ height: "176px", objectFit: "contain", marginLeft: "-42px" }} />
      ...
      {/* Search Bar */}
      <div style={{ display: "flex", alignItems: "center", gap: "8px", flex: 1, maxWidth: "480px", margin: "0 20px" }}>
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              padding: "7px 14px", fontSize: "14px",
          ...
          <button
            ...
            style={{
              ...
              borderLeft: "1px solid var(--search-border)",
        ...
        <button
          ...
          style={{
            ...
            background: listening ? "#e53e3e" : "var(--chip-bg)",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              transform: dropdownOpen ? "translateY(0) scale(1)" : "translateY(-10px) scale(0.97)",
              pointerEvents: dropdownOpen ? "all" : "none",
              transition: "opacity 0.18s ease, transform 0.18s ease",
            }}
          >
            <div style={{ position: "absolute", top: "-6px", right: "12px", width: "12px", height: "12px", background: "#fff", borderLeft: "1px solid #ececec", borderTop: "1px solid #ececec", transform: "rotate(45deg)", zIndex: 1 }} />
              ...
              <>
                ...
                {menuItems.map((item) => (
                  <Link key={item.href} href={item.href} onClick={() => setDropdownOpen(false)}
                    style={{ display: "flex", alignItems: "center", gap: "14px", padding: "11px 16px", fontSize: "14px", color: "#222", textDecoration: "none", transition: "background 0.1s ease" }}
